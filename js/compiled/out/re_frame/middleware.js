...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__18584){
...
return cljs.core.get_in.call(null,new_db,p1__18585_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__18586_SHARP_){
return cljs.core.get_in.call(null,db,p1__18586_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__18587__i = 0, G__18587__a = new Array(arguments.length -  2);
while (G__18587__i < G__18587__a.length) {G__18587__a[G__18587__i] = arguments[G__18587__i + 2]; ++G__18587__i;}
  in_paths = new cljs.core.IndexedSeq(G__18587__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__18588){
var f = cljs.core.first(arglist__18588);
arglist__18588 = cljs.core.next(arglist__18588);
var out_path = cljs.core.first(arglist__18588);
var in_paths = cljs.core.rest(arglist__18588);
...
//# sourceMappingURL=middleware.js.map?rel=1457668824067