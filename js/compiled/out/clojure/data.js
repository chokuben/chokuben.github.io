...
return cljs.core.reduce.call(null,(function (result,p__18557){
...
var vec__18560 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__18560,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__18560,(1),null);
var ab = cljs.core.nth.call(null,vec__18560,(2),null);
...
args18561.push((arguments[i__17878__auto___18565]));
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args18561.length)].join('')));
...
return (function (){var G__18571 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__18571) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1457668824005